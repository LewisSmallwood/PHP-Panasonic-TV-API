<?php
/**
 * A list of supported keys for Panasonic TVs.
 * User: LewisSmallwood
 * Date: 07/01/2019
 * Time: 02:38
 */
...
class Keys
{
    public static function getKeys()
    {
        return array(
            ...
            "NRC_RED-ONOFF",            // red button
            "NRC_GREEN-ONOFF",          // green button
            "NRC_YELLOW-ONOFF",         // yellow button
            "NRC_BLUE-ONOFF",           // blue button
